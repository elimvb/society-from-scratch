...
class Agent:
    ...
    def converse(self, incoming_message, partner_name, max_tokens=512, temperature=0.5):
        """Converse with another agent given the conversation context so far.
        
        Parameters:
        -----------
        incoming_message : str
            The message received from the other agent.
        partner_name : str
        ...
        What do you want to say to {partner_name}?
        (Say your part in the format of {self.first_name}: "[your response]". Don't try to play {partner_name}.)'''
